...
public class GameAnalyzer {
    ...
    // run past a minute on its own). Reset on every eval update (see
    // onBoardUpdate below), so it only fires when a ply goes genuinely
    // quiet - no update at all - for this long.
